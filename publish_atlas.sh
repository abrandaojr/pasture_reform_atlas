...
node --v8-pool-size=1 "$repo_dir/test_atlas_simulation.cjs"
...
git -C "$repo_dir" add atlas_language.js atlas_language_guides.json atlas_simulation.js atlas_simulation.css simulation_programs.json test_atlas_simulation.cjs test_atlas_language_browser.cjs docs/simulation_methodology_en.md
